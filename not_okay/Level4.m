...
shape1 = patch([4 6 6 4 4], [1.5 1.5 2.5 2.5 1.5], grey);
shape2 = patch([4 6 6 4 4], [3.5 3.5 4.5 4.5 3.5], grey);
shape3 = patch([4 6 6 4 4], [5.5 5.5 6.5 6.5 5.5], grey);
shape4 = patch([4 6 6 4 4], [7.5 7.5 8.5 8.5 7.5], grey);

%select position and launch angle of ball
[x0, y0, launchX, launchY, b_init, arrow] = userSelect([4 6 6 4 4 NaN...
    4 6 6 4 4 NaN 4 6 6 4 4 NaN 4 6 6 4 4], [1.5 1.5 2.5 2.5 1.5 NaN...
    3.5 3.5 4.5 4.5 3.5 NaN 5.5 5.5 6.5 6.5 5.5 NaN 7.5 7.5 8.5 8.5 7.5]);
    ...
    elseif key == 32
        ...
        while ballState(1) < 10 && ballState(1) > 0 && ballState(2) < 10 ...
            ...
            if ballState(end, 3) ~= oldBallState(end-1, 3) || ballState(end, 4)...
                ...
                if wallCollide(2) == 1.5 || wallCollide(2) == 2.5
                %make the first shape and corresponding walls disappear
                    delete(w1)
                    delete(shape1)
                    walls(1:4, :) = NaN(4,4);
                elseif wallCollide(2) == 3.5 || wallCollide(2) == 4.5
                %make the second shape and corresponding walls disappear
                    delete(w2)
                    delete(shape2)
                    walls(5:8, :) = NaN(4,4);
                elseif wallCollide(2) == 5.5 || wallCollide(2) == 6.5
                    %make the second shape and corresponding walls disappear
                    delete(w3)
                    delete(shape3)
                    walls(9:12, :) = NaN(4,4);
                elseif wallCollide(2) == 7.5 || wallCollide(2) == 8.5
                    %make the second shape and corresponding walls disappear
                    delete(w4)
                    delete(shape4)
                    walls(13:16, :) = NaN(4,4);
...
WinnerScreen([shape1, shape2, shape3, shape4], ballState(1), ballState(2), 'Level4.m')