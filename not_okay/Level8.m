...
shape1 = patch([1.5 3.5 4.5 2.5 1.5], [7.5 5.5 6.5 8.5 7.5], grey);
shape2 = patch([6.5 8.5 7.5 5.5 6.5], [4.5 2.5 1.5 3.5 4.5], grey);
shape3 = patch([6.5 8.5 7.5 5.5 6.5], [5.5 7.5 8.5 6.5 5.5], grey);
shape4 = patch([1.5 3.5 4.5 2.5 1.5], [2.5 4.5 3.5 1.5 2.5], grey);

%select position and launch angle of ball
[x0, y0, launchX, launchY, b_init, arrow] = userSelect([1.5 3.5 4.5 2.5 1.5...
    NaN 6.5 8.5 7.5 5.5 6.5 NaN 6.5 8.5 7.5 5.5 6.5 NaN 1.5 3.5 4.5 2.5 1.5],...
    [7.5 5.5 6.5 8.5 7.5 NaN 4.5 2.5 1.5 3.5 4.5 NaN 5.5 7.5 8.5 6.5 5.5...
    NaN 2.5 4.5 3.5 1.5 2.5]);
    ...
    elseif key == 32
        ...
        while ballState(1) < 10 && ballState(1) > 0 && ballState(2) < 10 ...
            ...
            if ballState(end, 3) ~= oldBallState(end-1, 3) || ballState(end, 4)...
                ...
                if (wallCollide(2) == 5.5 || wallCollide(2) == 7.5 ...
                        || wallCollide(2) == 8.5)...
                        && (wallCollide(1) == 1.5 || wallCollide(1) == 2.5 ...
                        || wallCollide(1) == 3.5)
                ...
                elseif (wallCollide(2) == 1.5 || wallCollide(2) == 3.5 ...
                        || wallCollide(2) == 4.5)...
                        && (wallCollide(1) == 5.5 || wallCollide(1) == 6.5 ...
                        || wallCollide(1) == 7.5)
                %make the second shape and corresponding walls disappear
                    delete(w2)
                    delete(shape2)
                    walls(5:8, :) = NaN(4,4);
                elseif (wallCollide(2) == 5.5...
                        || wallCollide(2) == 7.5 || wallCollide(2) == 8.5)...
                        && (wallCollide(1) == 6.5 ...
                    ...
                    delete(shape3)
                    walls(9:12, :) = NaN(4,4);
                elseif (wallCollide(2) == 1.5 ...
                        || wallCollide(2) == 3.5 || wallCollide(2) == 4.5)...
                        && (wallCollide(1) == 2.5 ...
                        || wallCollide(1) == 3.5 || wallCollide(1) == 4.5)
                    %make the second shape and corresponding walls disappear
                    delete(w4)
                    delete(shape4)
                    walls(13:16, :) = NaN(4,4);
